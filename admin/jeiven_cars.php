        ...
        if (!$vehicleId) {
            ...
            if ($stmt) {
                ...
                if ($stmt->execute() && $stmt->affected_rows === 1) {
                    if ($imagePath !== '' && str_starts_with($imagePath, 'assets/cars/')) {
